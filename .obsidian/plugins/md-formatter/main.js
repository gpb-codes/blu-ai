...
var DEFAULT_RULES_YAML = `# MD \u6392\u7248\u7F8E\u5316\u5668 - \u89C4\u5219\u6A21\u677F
# \u4FEE\u6539\u540E\u4FDD\u5B58\uFF0C\u7ACB\u5373\u751F\u6548
...
var FormatterEngine = class {
  ...
  collectListLines(lines, start, isItem) {
    const result = [];
    let i = start;
    while (i < lines.length) {
  ...
  // ---- 间距辅助 ----
  ensureBlankBefore(blocks, count) {
    if (count <= 0) return;
  ...
  formatList(lines, ordered, rules) {
...
var MdFormatterSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).addButton(
      (btn) => btn.setButtonText("\u4FDD\u5B58\u89C4\u5219").setCta().onClick(async () => {
        try {
      ...
      (btn) => btn.setButtonText("\u6062\u590D\u9ED8\u8BA4").onClick(async () => {
        ...
        new import_obsidian.Notice("\u5DF2\u6062\u590D\u4E3A\u9ED8\u8BA4\u89C4\u5219");
      })
    );
...
var MdFormatterPlugin = class extends import_obsidian2.Plugin {
  constructor() {
    super(...arguments);
    this.settings = DEFAULT_SETTINGS;
    this.engine = new FormatterEngine();
  }
  async onload() {
    ...
    this.registerEvent(
      this.app.workspace.on("editor-menu", (menu, editor) => {
        menu.addItem((item) => {
          item.setTitle("\u7F8E\u5316 Markdown \u6392\u7248").setIcon("lines-of-text").onClick(() => this.formatCurrentFile(editor));
        });
      })
    );
    this.addCommand({
      ...
      name: "\u7F8E\u5316\u5F53\u524D MD \u6392\u7248",
      editorCallback: (editor) => this.formatCurrentFile(editor)
    });
    this.addCommand({
  ...
  formatCurrentFile(editor) {
    const text = editor.getValue();
    if (!text.trim()) {
      new import_obsidian2.Notice("\u6587\u4EF6\u4E3A\u7A7A\uFF0C\u65E0\u9700\u7F8E\u5316");
      return;
    }
    try {
      this.engine = new FormatterEngine(this.settings.rules);
      ...
      if (formatted === text) {
        new import_obsidian2.Notice("\u6392\u7248\u5DF2\u89C4\u8303\uFF0C\u65E0\u9700\u4FEE\u6539");
        return;
      }
      editor.setValue(formatted);
      new import_obsidian2.Notice("\u6392\u7248\u7F8E\u5316\u5B8C\u6210");
    } catch (e) {
      new import_obsidian2.Notice("\u7F8E\u5316\u5931\u8D25: " + e.message);
    }
  }
  async formatAllInFolder() {
    const activeFile = this.app.workspace.getActiveFile();
    if (!activeFile) {
      new import_obsidian2.Notice("\u8BF7\u5148\u6253\u5F00\u4E00\u4E2A\u6587\u4EF6\u4EE5\u786E\u5B9A\u76EE\u6807\u6587\u4EF6\u5939");
      return;
    }
    const folder = activeFile.parent;
    const files = folder == null ? void 0 : folder.children.filter(
      (f) => f instanceof import_obsidian2.TFile && f.extension === "md"
    );
    if (!files || files.length === 0) {
      new import_obsidian2.Notice("\u5F53\u524D\u6587\u4EF6\u5939\u4E0B\u6CA1\u6709 Markdown \u6587\u4EF6");
      return;
    }
    let count = 0;
    ...
    new import_obsidian2.Notice(`\u7F8E\u5316\u5B8C\u6210\uFF0C\u5171\u5904\u7406 ${count}/${files.length} \u4E2A\u6587\u4EF6`);
  }
  async loadSettings() {
