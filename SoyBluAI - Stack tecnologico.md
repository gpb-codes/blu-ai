...
> ⚠️ **Nota:** D1 es SQLite, no PostgreSQL — no hay pgvector nativo (por eso Vectorize aparte para vectores). Pendiente: ORM/capa de acceso a datos (Prisma no soporta D1 nativamente), solución de auth (D1 no la incluye), y si el hosting se mueve de Vercel a Cloudflare Workers/Pages. Fuente: [[SoyBluAI - Bitacora]].
...
- **Next.js 15** — landing, pricing, login web, editor **SoyBluAI Code web** (Monaco + GitHub OAuth), panel admin.
...
Ver también: [[SoyBluAI - Gateway y Modelos]], [[SoyBluAI - Roadmap y estado]].