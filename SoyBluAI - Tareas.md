...
> Backlog del equipo, sincronizado desde Notion (base "Tareas SoyBluAI"). Tablero visual: [[SoyBluAI - Kanban]]. Fuente viva: Notion > SoyBluAI.
...
| Arrancar contenido: 10 publicaciones por semana | Sin empezar | Alta | 2026-08-01 | Ignacio + Marketing | 5 en cuenta personal + 5 en cuenta oficial de SoyBluAI. Empieza sin esperar al producto. |
...
- **Origen único:** Notion (base "Tareas SoyBluAI") — si cambias algo en Notion, pedir re-sincronización para volcarlo aquí.
- **Visualización:** arrastrar tarjetas se hace en [[SoyBluAI - Kanban]]; esta nota refleja el estado de Notion.
...
- **Reorganización 17-ago-2026:** [[SoyBluAI - Kanban]] pasa de columnas por estado a columnas por responsable (Gabriel, Pablo, Ignacio, Ignacio + Marketing); el estado ahora se marca con casilla (✅ listo), 🔄 (en progreso) o ⚠️ (atrasada) dentro de cada tarjeta.