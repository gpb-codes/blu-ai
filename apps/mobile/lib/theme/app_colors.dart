...
class AppPalette {
  ...
  /// Tema claro (por defecto): blanco puro con azul #0A34F5 — espejo del screenshot
  /// oscuro pero en claro. Sidebar gris muy claro #F8FAFC, superficies blancas.
  static const light = AppPalette(
    ...
    textQuaternary: Color(0xFF94A3B8),
    elevatedOverlay: Color(0xFFFFFFFF),
    success: Color(0xFF16A34A),
    successContainer: Color(0x1A16A34A),
