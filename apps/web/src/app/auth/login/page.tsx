// Página de inicio de sesión con el diseño soybluia (fondo y tarjetas dark).
    ...
    <div className="flex flex-1 items-center justify-center bg-blu-bg p-6">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-blu-outline/20 bg-blu-surface-low p-6">
          <h1 className="font-geist text-2xl font-semibold text-blu-on">Iniciar sesión</h1>
          <p className="mt-1 text-sm text-blu-on-variant">Bienvenido de vuelta a BLU.</p>
          ...
          <p className="mt-4 text-center text-sm text-blu-on-variant">
            ¿No tienes cuenta?{" "}
            <Link href="/auth/register" className="font-medium text-blu-primary hover:underline">
              Regístrate
            </Link>
          </p>
        </div>
